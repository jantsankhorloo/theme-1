...
$( "#contactForm" ).submit( function( e ) {
    ...
    $.ajax( {
        ...
        url: "https://testformspree.com/darmaa.am@gmail.com",
        method: "POST",
        data: $( this ).serialize(),
        dataType: "json",
        ...
        success: function( data ) {
            ...
            $btn.text( "Send" );
            openModal();
            $( ".modal__body" ).append( "<h1>Thanks " + $name + "!</h1><p>Your message was successfully sent! We will get back to you soon.</p>" );
